...
<?php
    ...
    if($delet)	{    
        ...
        $result2 = mysql_query($sql2, $link) or die ("Ошибка запроса удаления мест");
        
        $sql = 'DELETE FROM afisha WHERE kod_sobitia="'.$kod_sobitia.'"';
        $result = mysql_query($sql, $link) or die ("Ошибка запроса удаления из афиши");  
        
        $str = "Представление удалено !<br>";
        echo $str;
    }
